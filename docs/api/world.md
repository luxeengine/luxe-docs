...
You can play multiple animations at the same time, for example, the player might have a _walk_ animation playing and you play a _glowing_ animation on top. 
...
- [create](#Anim.create)(**entity**: `Any`)
- [destroy](#Anim.destroy)(**entity**: `Any`)
- [has](#Anim.has)(**entity**: `Any`)
- [valid](#Anim.valid+2)(**entity**: `Any`, **anim**: `Any`)
- [get_source_id](#Anim.get_source_id+2)(**entity**: `Any`, **anim**: `Any`)
- [get_state](#Anim.get_state+2)(**entity**: `Any`, **anim**: `Any`)
- [get_active_anims](#Anim.get_active_anims)(**entity**: `Any`)
- [play](#Anim.play+3)(**entity**: `Any`, **anim_lx**: `Any`, **time_offset**: `Any`)
- [play](#Anim.play+2)(**entity**: `Any`, **anim_lx**: `Any`)
- [play_only](#Anim.play_only+3)(**entity**: `Any`, **anim_lx**: `Any`, **time_offset**: `Any`)
- [play_only](#Anim.play_only+2)(**entity**: `Any`, **anim_lx**: `Any`)
- [stop](#Anim.stop+3)(**entity**: `Any`, **anim**: `Any`, **reset**: `Any`)
- [stop](#Anim.stop+2)(**entity**: `Any`, **anim**: `Any`)
- [stop_all](#Anim.stop_all+2)(**entity**: `Any`, **reset**: `Any`)
- [stop_all](#Anim.stop_all)(**entity**: `Any`)
- [create_track](#Anim.create_track+4)(**entity**: `Any`, **anim**: `Any`, **track_id**: `Any`, **track_type**: `Any`)
- [has_track](#Anim.has_track+3)(**entity**: `Any`, **anim**: `Any`, **track_id**: `Any`)
- [track_set_range](#Anim.track_set_range+5)(**entity**: `Any`, **anim**: `Any`, **track_id**: `Any`, **min**: `Any`, **max**: `Any`)
- [track_get_range](#Anim.track_get_range+3)(**entity**: `Any`, **anim**: `Any`, **track_id**: `Any`)
- [track_set](#Anim.track_set+5)(**entity**: `Any`, **anim**: `Any`, **track_id**: `Any`, **property**: `Any`, **value**: `Any`)
- [track_set_channel](#Anim.track_set_channel+7)(**entity**: `Any`, **anim**: `Any`, **track_id**: `Any`, **channel_id**: `Any`, **channel_idx**: `Any`, **interp**: `Any`, **keys**: `Any`)
- [set_play_count](#Anim.set_play_count+3)(**entity**: `Any`, **anim**: `Any`, **play_count**: `Any`)
- [set_rate](#Anim.set_rate+3)(**entity**: `Any`, **anim**: `Any`, **rate**: `Any`)
- [set_start](#Anim.set_start+3)(**entity**: `Any`, **anim**: `Any`, **start**: `Any`)
- [set_end](#Anim.set_end+3)(**entity**: `Any`, **anim**: `Any`, **end**: `Any`)
- [set_interval_time](#Anim.set_interval_time+3)(**entity**: `Any`, **anim**: `Any`, **time**: `Any`)
- [get_interval_time](#Anim.get_interval_time+2)(**entity**: `Any`, **anim**: `Any`)
- [get_play_count](#Anim.get_play_count+2)(**entity**: `Any`, **anim**: `Any`)
- [get_rate](#Anim.get_rate+2)(**entity**: `Any`, **anim**: `Any`)
- [get_duration](#Anim.get_duration+2)(**entity**: `Any`, **anim**: `Any`)
- [get_start](#Anim.get_start+2)(**entity**: `Any`, **anim**: `Any`)
- [get_end](#Anim.get_end+2)(**entity**: `Any`, **anim**: `Any`)
- [on_event](#Anim.on_event+3)(**entity**: `Any`, **anim**: `Any`, **fn**: `Any`)

<hr/>
<endpoint module="luxe: world" class="Anim" signature="create(entity : Any)"></endpoint>
<signature id="Anim.create">Anim.create(**entity**: `Any`)
...
<endpoint module="luxe: world" class="Anim" signature="destroy(entity : Any)"></endpoint>
<signature id="Anim.destroy">Anim.destroy(**entity**: `Any`)
...
<endpoint module="luxe: world" class="Anim" signature="has(entity : Any)"></endpoint>
<signature id="Anim.has">Anim.has(**entity**: `Any`)
<a class="headerlink" href="#Anim.has" title="Permanent link">¶</a></signature>
<span class='api_ret'>returns</span> `:::js Bool`
> Returns true if `entity` has an `Anim` modifier attached.   
```js
if(Anim.has(entity)) {
...
<endpoint module="luxe: world" class="Anim" signature="valid(entity : Any, anim : Any)"></endpoint>
<signature id="Anim.valid+2">Anim.valid(**entity**: `Any`, **anim**: `Any`)
<a class="headerlink" href="#Anim.valid+2" title="Permanent link">¶</a></signature>
<span class='api_ret'>returns</span> `:::js Bool`
> Returns true if the `Anim` instance is valid for the `Anim` attached to `entity`.   
```js
...
<endpoint module="luxe: world" class="Anim" signature="get_source_id(entity : Any, anim : Any)"></endpoint>
<signature id="Anim.get_source_id+2">Anim.get_source_id(**entity**: `Any`, **anim**: `Any`)
...
<endpoint module="luxe: world" class="Anim" signature="get_state(entity : Any, anim : Any)"></endpoint>
<signature id="Anim.get_state+2">Anim.get_state(**entity**: `Any`, **anim**: `Any`)
...
<endpoint module="luxe: world" class="Anim" signature="get_active_anims(entity : Any)"></endpoint>
<signature id="Anim.get_active_anims">Anim.get_active_anims(**entity**: `Any`)
<a class="headerlink" href="#Anim.get_active_anims" title="Permanent link">¶</a></signature>
<span class='api_ret'>returns</span> `:::js List of Anim`
...
<endpoint module="luxe: world" class="Anim" signature="play(entity : Any, anim_lx : Any, time_offset : Any)"></endpoint>
<signature id="Anim.play+3">Anim.play(**entity**: `Any`, **anim_lx**: `Any`, **time_offset**: `Any`)
<a class="headerlink" href="#Anim.play+3" title="Permanent link">¶</a></signature>
<span class='api_ret'>returns</span> `:::js Anim`
> Play the animation asset `anim_lx` on the `Anim` attached to `entity`. The `time_offset` is a time in seconds to begin playback from. For example, you might pause an animation and hold onto the animation time when it was paused. Then when resuming, you can play from the new time.   
```js
var anim = Anim.play(entity, "player/idle", 0.5)
```

<endpoint module="luxe: world" class="Anim" signature="play(entity : Any, anim_lx : Any)"></endpoint>
<signature id="Anim.play+2">Anim.play(**entity**: `Any`, **anim_lx**: `Any`)
<a class="headerlink" href="#Anim.play+2" title="Permanent link">¶</a></signature>
<span class='api_ret'>returns</span> `:::js Anim`
> Play the animation asset `anim_lx` on the `Anim` attached to `entity`. Plays from the beginning.   
```js
var anim = Anim.play(entity, "player/idle")
```

<endpoint module="luxe: world" class="Anim" signature="play_only(entity : Any, anim_lx : Any, time_offset : Any)"></endpoint>
<signature id="Anim.play_only+3">Anim.play_only(**entity**: `Any`, **anim_lx**: `Any`, **time_offset**: `Any`)
<a class="headerlink" href="#Anim.play_only+3" title="Permanent link">¶</a></signature>
<span class='api_ret'>returns</span> `:::js Anim`
> Play the animation asset `anim_lx` on the `Anim` attached to `entity`, stopping all other active anims, and only playing this one. The `time_offset` is a time in seconds to begin playback from.   
```js
var anim = Anim.play_only(entity, "player/idle", 0.5)
```

<endpoint module="luxe: world" class="Anim" signature="play_only(entity : Any, anim_lx : Any)"></endpoint>
<signature id="Anim.play_only+2">Anim.play_only(**entity**: `Any`, **anim_lx**: `Any`)
<a class="headerlink" href="#Anim.play_only+2" title="Permanent link">¶</a></signature>
<span class='api_ret'>returns</span> `:::js Anim`
> Play the animation asset `anim_lx` on the `Anim` attached to `entity`, stopping all other active anims, and only playing this one.   
```js
var anim = Anim.play_only(entity, "player/idle")
```

<endpoint module="luxe: world" class="Anim" signature="stop(entity : Any, anim : Any, reset : Any)"></endpoint>
<signature id="Anim.stop+3">Anim.stop(**entity**: `Any`, **anim**: `Any`, **reset**: `Any`)
...
<endpoint module="luxe: world" class="Anim" signature="stop(entity : Any, anim : Any)"></endpoint>
<signature id="Anim.stop+2">Anim.stop(**entity**: `Any`, **anim**: `Any`)
<a class="headerlink" href="#Anim.stop+2" title="Permanent link">¶</a></signature>
<span class='api_ret'>returns</span> `:::js None`
> Stop the `Anim` instance if playing on the `Anim` attached to `entity`. State is not reset (see [Anim.stop(entity, anim, reset)](#Anim.stop+3)).   
```js
var anim = Anim.play(entity, "player/idle")
Anim.stop(entity, anim)
```

<endpoint module="luxe: world" class="Anim" signature="stop_all(entity : Any, reset : Any)"></endpoint>
<signature id="Anim.stop_all+2">Anim.stop_all(**entity**: `Any`, **reset**: `Any`)
<a class="headerlink" href="#Anim.stop_all+2" title="Permanent link">¶</a></signature>
<span class='api_ret'>returns</span> `:::js None`
> Stop all active `Anim` instances on the `Anim` attached to `entity`. If `reset` is true, state before animating will be reset (see [Anim.stop(entity, anim, reset)](#Anim.stop+3)).   
```js
Anim.stop_all(entity, true)
```

<endpoint module="luxe: world" class="Anim" signature="stop_all(entity : Any)"></endpoint>
<signature id="Anim.stop_all">Anim.stop_all(**entity**: `Any`)
<a class="headerlink" href="#Anim.stop_all" title="Permanent link">¶</a></signature>
<span class='api_ret'>returns</span> `:::js None`
> Stop all active `Anim` instances on the `Anim` attached to `entity`. State is not reset (see [Anim.stop(entity, anim, reset)](#Anim.stop+3)).   
```js
Anim.stop_all(entity)
```

<endpoint module="luxe: world" class="Anim" signature="create_track(entity : Any, anim : Any, track_id : Any, track_type : Any)"></endpoint>
<signature id="Anim.create_track+4">Anim.create_track(**entity**: `Any`, **anim**: `Any`, **track_id**: `Any`, **track_type**: `Any`)
...
<endpoint module="luxe: world" class="Anim" signature="has_track(entity : Any, anim : Any, track_id : Any)"></endpoint>
<signature id="Anim.has_track+3">Anim.has_track(**entity**: `Any`, **anim**: `Any`, **track_id**: `Any`)
...
<endpoint module="luxe: world" class="Anim" signature="track_set_range(entity : Any, anim : Any, track_id : Any, min : Any, max : Any)"></endpoint>
<signature id="Anim.track_set_range+5">Anim.track_set_range(**entity**: `Any`, **anim**: `Any`, **track_id**: `Any`, **min**: `Any`, **max**: `Any`)
...
<endpoint module="luxe: world" class="Anim" signature="track_get_range(entity : Any, anim : Any, track_id : Any)"></endpoint>
<signature id="Anim.track_get_range+3">Anim.track_get_range(**entity**: `Any`, **anim**: `Any`, **track_id**: `Any`)
...
<endpoint module="luxe: world" class="Anim" signature="track_set(entity : Any, anim : Any, track_id : Any, property : Any, value : Any)"></endpoint>
<signature id="Anim.track_set+5">Anim.track_set(**entity**: `Any`, **anim**: `Any`, **track_id**: `Any`, **property**: `Any`, **value**: `Any`)
...
<endpoint module="luxe: world" class="Anim" signature="track_set_channel(entity : Any, anim : Any, track_id : Any, channel_id : Any, channel_idx : Any, interp : Any, keys : Any)"></endpoint>
<signature id="Anim.track_set_channel+7">Anim.track_set_channel(**entity**: `Any`, **anim**: `Any`, **track_id**: `Any`, **channel_id**: `Any`, **channel_idx**: `Any`, **interp**: `Any`, **keys**: `Any`)
...
<endpoint module="luxe: world" class="Anim" signature="set_play_count(entity : Any, anim : Any, play_count : Any)"></endpoint>
<signature id="Anim.set_play_count+3">Anim.set_play_count(**entity**: `Any`, **anim**: `Any`, **play_count**: `Any`)
<a class="headerlink" href="#Anim.set_play_count+3" title="Permanent link">¶</a></signature>
<span class='api_ret'>returns</span> `:::js None`
> Set the amount of times to play the `Anim` instance on the `Anim` attached to `entity`. The `play_count` value can be `0`, which will loop.   
```js
...
<endpoint module="luxe: world" class="Anim" signature="set_rate(entity : Any, anim : Any, rate : Any)"></endpoint>
<signature id="Anim.set_rate+3">Anim.set_rate(**entity**: `Any`, **anim**: `Any`, **rate**: `Any`)
...
<endpoint module="luxe: world" class="Anim" signature="set_start(entity : Any, anim : Any, start : Any)"></endpoint>
<signature id="Anim.set_start+3">Anim.set_start(**entity**: `Any`, **anim**: `Any`, **start**: `Any`)
<a class="headerlink" href="#Anim.set_start+3" title="Permanent link">¶</a></signature>
<span class='api_ret'>returns</span> `:::js None`
> Set the start marker of the `Anim` instance on the `Anim` attached to `entity`.
> **note** This API is WIP.   
```js
Anim.set_start(entity, anim, 0)
```

<endpoint module="luxe: world" class="Anim" signature="set_end(entity : Any, anim : Any, end : Any)"></endpoint>
<signature id="Anim.set_end+3">Anim.set_end(**entity**: `Any`, **anim**: `Any`, **end**: `Any`)
<a class="headerlink" href="#Anim.set_end+3" title="Permanent link">¶</a></signature>
<span class='api_ret'>returns</span> `:::js None`
> Set the end marker of the `Anim` instance on the `Anim` attached to `entity`.
> **note** This API is WIP.   
```js
Anim.set_end(entity, anim, 1)
```

<endpoint module="luxe: world" class="Anim" signature="set_interval_time(entity : Any, anim : Any, time : Any)"></endpoint>
<signature id="Anim.set_interval_time+3">Anim.set_interval_time(**entity**: `Any`, **anim**: `Any`, **time**: `Any`)
...
<endpoint module="luxe: world" class="Anim" signature="get_interval_time(entity : Any, anim : Any)"></endpoint>
<signature id="Anim.get_interval_time+2">Anim.get_interval_time(**entity**: `Any`, **anim**: `Any`)
<a class="headerlink" href="#Anim.get_interval_time+2" title="Permanent link">¶</a></signature>
<span class='api_ret'>returns</span> `:::js Num`
> Return the current playback time of the `Anim` instance on the `Anim` attached to `entity`.
> **note** This API is WIP.   
```js
var time_now = Anim.get_interval_time(entity, anim)
```

<endpoint module="luxe: world" class="Anim" signature="get_play_count(entity : Any, anim : Any)"></endpoint>
<signature id="Anim.get_play_count+2">Anim.get_play_count(**entity**: `Any`, **anim**: `Any`)
...
<endpoint module="luxe: world" class="Anim" signature="get_rate(entity : Any, anim : Any)"></endpoint>
<signature id="Anim.get_rate+2">Anim.get_rate(**entity**: `Any`, **anim**: `Any`)
<a class="headerlink" href="#Anim.get_rate+2" title="Permanent link">¶</a></signature>
<span class='api_ret'>returns</span> `:::js Num`
> Return the rate of playback for the `Anim` instance on the `Anim` attached to `entity`.   
```js
var rate = Anim.get_rate(entity, anim)
```

<endpoint module="luxe: world" class="Anim" signature="get_duration(entity : Any, anim : Any)"></endpoint>
<signature id="Anim.get_duration+2">Anim.get_duration(**entity**: `Any`, **anim**: `Any`)
...
```js
var length = Anim.get_duration(entity, anim)
```

<endpoint module="luxe: world" class="Anim" signature="get_start(entity : Any, anim : Any)"></endpoint>
<signature id="Anim.get_start+2">Anim.get_start(**entity**: `Any`, **anim**: `Any`)
...
```js
var start = Anim.get_start(entity, anim)
```

<endpoint module="luxe: world" class="Anim" signature="get_end(entity : Any, anim : Any)"></endpoint>
<signature id="Anim.get_end+2">Anim.get_end(**entity**: `Any`, **anim**: `Any`)
...
```js
var end = Anim.get_end(entity, anim)
```

<endpoint module="luxe: world" class="Anim" signature="on_event(entity : Any, anim : Any, fn : Any)"></endpoint>
<signature id="Anim.on_event+3">Anim.on_event(**entity**: `Any`, **anim**: `Any`, **fn**: `Any`)
...
- [name](#AnimInterpolation.name)(**value**: `Any`)
- [from_string](#AnimInterpolation.from_string)(**value**: `Any`)
...
<span class='api_ret'>returns</span> `:::js AnimInterpolation`
> The animation values between keys would not be interpolated, they would jump from one value to the next. For example if your keys were `{ time=0 value=0 }` and `{ time=1 value=3 }`, with discrete the value at time `0.5` is still 0 (instead of `1.5`). It will only change to `3` when the next key is reached.   
```js
...
<endpoint module="luxe: world" class="AnimInterpolation" signature="name(value : Any)"></endpoint>
<signature id="AnimInterpolation.name">AnimInterpolation.name(**value**: `Any`)
...
<endpoint module="luxe: world" class="AnimInterpolation" signature="from_string(value : Any)"></endpoint>
<signature id="AnimInterpolation.from_string">AnimInterpolation.from_string(**value**: `Any`)
...
- [name](#AnimState.name)(**value**: `Any`)
- [from_string](#AnimState.from_string)(**value**: `Any`)
...
<endpoint module="luxe: world" class="AnimState" signature="name(value : Any)"></endpoint>
<signature id="AnimState.name">AnimState.name(**value**: `Any`)
...
<endpoint module="luxe: world" class="AnimState" signature="from_string(value : Any)"></endpoint>
<signature id="AnimState.from_string">AnimState.from_string(**value**: `Any`)
...
- [create](#Entity.create)(**world**: `Any`)
- [create](#Entity.create+2)(**world**: `Any`, **name**: `Any`)
- [valid](#Entity.valid)(**entity**: `Any`)
- [get_world](#Entity.get_world)(**entity**: `Any`)
- [get](#Entity.get)(**uuid**: `Any`)
- [get_named](#Entity.get_named+2)(**world**: `Any`, **name**: `Any`)
- [get_named_all](#Entity.get_named_all+2)(**world**: `Any`, **name**: `Any`)
- [get_name](#Entity.get_name)(**entity**: `Any`)
- [set_name](#Entity.set_name+2)(**entity**: `Any`, **name**: `Any`)
...
<span class='api_ret'>returns</span> `:::js None`
> Attach a `Sprite` modifier to `entity`, drawn using `material`, with a size of `width`x`height`.   
```js
var entity = Entity.create(world)
...
<span class='api_ret'>returns</span> `:::js Vec4`
