...
<endpoint module="luxe: render" class="ComputeLayerDesc" signature="x=(v : Any)"></endpoint>
...
<endpoint module="luxe: render" class="MaterialInputType" signature="bool3"></endpoint>
<signature id="MaterialInputType.bool3">MaterialInputType.bool3
<a class="headerlink" href="#MaterialInputType.bool3" title="Permanent link">¶</a></signature>
<span class='api_ret'>returns</span> `:::js unknown`
> :todo: desc   
```js
//:todo: example
...
<endpoint module="luxe: render" class="MaterialInputType" signature="int3"></endpoint>
<signature id="MaterialInputType.int3">MaterialInputType.int3
<a class="headerlink" href="#MaterialInputType.int3" title="Permanent link">¶</a></signature>
<span class='api_ret'>returns</span> `:::js unknown`
> :todo: desc   
```js
//:todo: example
...
<endpoint module="luxe: render" class="MaterialInputType" signature="uint3"></endpoint>
<signature id="MaterialInputType.uint3">MaterialInputType.uint3
<a class="headerlink" href="#MaterialInputType.uint3" title="Permanent link">¶</a></signature>
<span class='api_ret'>returns</span> `:::js unknown`
> :todo: desc   
```js
//:todo: example
...
<endpoint module="luxe: render" class="MaterialInputType" signature="float3"></endpoint>
<signature id="MaterialInputType.float3">MaterialInputType.float3
<a class="headerlink" href="#MaterialInputType.float3" title="Permanent link">¶</a></signature>
<span class='api_ret'>returns</span> `:::js unknown`
> :todo: desc   
```js
//:todo: example
...
- [dispatch](#Render.dispatch+5)(**library**: `Any`, **function**: `Any`, **x**: `Any`, **y**: `Any`, **z**: `Any`)
- [submit](#Render.submit+6)(**set**: `Any`, **target_path**: `Any`, **target_resource**: `Any`, **target_region**: `Any`, **mat_proj**: `Any`, **mat_view**: `Any`)
- [submit_now](#Render.submit_now+6)(**set**: `Any`, **target_path**: `Any`, **target_resource**: `Any`, **target_region**: `Any`, **mat_proj**: `Any`, **mat_view**: `Any`)
- [submit_fn](#Render.submit_fn+8)(**set**: `Any`, **target_path**: `Any`, **target_resource**: `Any`, **target_region**: `Any`, **mat_proj**: `Any`, **mat_view**: `Any`, **settings**: `Any`, **fn**: `Any`)
- [create_set](#Render.create_set)()
- [destroy_set](#Render.destroy_set)(**set**: `Any`)
- [valid_set](#Render.valid_set)(**set**: `Any`)
- [set_add](#Render.set_add+2)(**set**: `Any`, **geo**: `Any`)
- [set_remove](#Render.set_remove+2)(**set**: `Any`, **geo**: `Any`)
- [set_get_geometry](#Render.set_get_geometry+2)(**set**: `Any`, **into**: `Any`)
- [set_get_count](#Render.set_get_count)(**set**: `Any`)
- [create_path](#Render.create_path)()
- [destroy_path](#Render.destroy_path)(**path**: `Any`)
- [valid_path](#Render.valid_path)(**path**: `Any`)
...
<hr/>
<endpoint module="luxe: render" class="Render" signature="dispatch(library : Any, function : Any, x : Any, y : Any, z : Any)"></endpoint>
<signature id="Render.dispatch+5">Render.dispatch(**library**: `Any`, **function**: `Any`, **x**: `Any`, **y**: `Any`, **z**: `Any`)
...
<endpoint module="luxe: render" class="Render" signature="submit(set : Any, target_path : Any, target_resource : Any, target_region : Any, mat_proj : Any, mat_view : Any)"></endpoint>
<signature id="Render.submit+6">Render.submit(**set**: `Any`, **target_path**: `Any`, **target_resource**: `Any`, **target_region**: `Any`, **mat_proj**: `Any`, **mat_view**: `Any`)
...
<endpoint module="luxe: render" class="Render" signature="submit_now(set : Any, target_path : Any, target_resource : Any, target_region : Any, mat_proj : Any, mat_view : Any)"></endpoint>
<signature id="Render.submit_now+6">Render.submit_now(**set**: `Any`, **target_path**: `Any`, **target_resource**: `Any`, **target_region**: `Any`, **mat_proj**: `Any`, **mat_view**: `Any`)
...
<endpoint module="luxe: render" class="Render" signature="submit_fn(set : Any, target_path : Any, target_resource : Any, target_region : Any, mat_proj : Any, mat_view : Any, settings : Any, fn : Any)"></endpoint>
<signature id="Render.submit_fn+8">Render.submit_fn(**set**: `Any`, **target_path**: `Any`, **target_resource**: `Any`, **target_region**: `Any`, **mat_proj**: `Any`, **mat_view**: `Any`, **settings**: `Any`, **fn**: `Any`)
...
<endpoint module="luxe: render" class="Render" signature="destroy_set(set : Any)"></endpoint>
<signature id="Render.destroy_set">Render.destroy_set(**set**: `Any`)
...
<endpoint module="luxe: render" class="Render" signature="valid_set(set : Any)"></endpoint>
<signature id="Render.valid_set">Render.valid_set(**set**: `Any`)
...
<endpoint module="luxe: render" class="Render" signature="set_add(set : Any, geo : Any)"></endpoint>
<signature id="Render.set_add+2">Render.set_add(**set**: `Any`, **geo**: `Any`)
...
<endpoint module="luxe: render" class="Render" signature="set_remove(set : Any, geo : Any)"></endpoint>
<signature id="Render.set_remove+2">Render.set_remove(**set**: `Any`, **geo**: `Any`)
...
<endpoint module="luxe: render" class="Render" signature="set_get_geometry(set : Any, into : Any)"></endpoint>
<signature id="Render.set_get_geometry+2">Render.set_get_geometry(**set**: `Any`, **into**: `Any`)
...
<endpoint module="luxe: render" class="Render" signature="set_get_count(set : Any)"></endpoint>
<signature id="Render.set_get_count">Render.set_get_count(**set**: `Any`)
...
<endpoint module="luxe: render" class="Render" signature="destroy_path(path : Any)"></endpoint>
<signature id="Render.destroy_path">Render.destroy_path(**path**: `Any`)
...
<endpoint module="luxe: render" class="Render" signature="valid_path(path : Any)"></endpoint>
<signature id="Render.valid_path">Render.valid_path(**path**: `Any`)
...
<endpoint module="luxe: render" class="Render" signature="path_add_compute_layer(path : Any, name : Any, layer : Any)"></endpoint>
<signature id="Render.path_add_compute_layer+3">Render.path_add_compute_layer(**path**: `Any`, **name**: `Any`, **layer**: `Any`)
<a class="headerlink" href="#Render.path_add_compute_layer+3" title="Permanent link">¶</a></signature>
<span class='api_ret'>returns</span> `:::js unknown`
> :todo: desc   
```js
//:todo: example
...
<endpoint module="luxe: render" class="Render" signature="define_compute(name : Any, library : Any, function : Any)"></endpoint>
<signature id="Render.define_compute+3">Render.define_compute(**name**: `Any`, **library**: `Any`, **function**: `Any`)
<a class="headerlink" href="#Render.define_compute+3" title="Permanent link">¶</a></signature>
<span class='api_ret'>returns</span> `:::js unknown`
> :todo: desc   
```js
//:todo: example
...
- [new](#RenderPathContext.new+2)(**path**: `Any`, **settings**: `Any`)
- [path](#RenderPathContext.path)
- [layer_render](#RenderPathContext.layer_render+2)(**name**: `Any`, **render_layer_desc**: `Any`)
...
- [layer_compute](#RenderPathContext.layer_compute+2)(**name**: `Any`, **compute_layer_desc**: `Any`)
- [get](#RenderPathContext.get+2)(**key**: `Any`, **default**: `Any`)
- [set](#RenderPathContext.set+2)(**key**: `Any`, **value**: `Any`)

<hr/>
<endpoint module="luxe: render" class="RenderPathContext" signature="new(path : Any, settings : Any)"></endpoint>
<signature id="RenderPathContext.new+2">RenderPathContext.new(**path**: `Any`, **settings**: `Any`)
...
<endpoint module="luxe: render" class="RenderPathContext" signature="layer_render(name : Any, render_layer_desc : Any)"></endpoint>
<signature id="RenderPathContext.layer_render+2">RenderPathContext.layer_render(**name**: `Any`, **render_layer_desc**: `Any`)
...
<endpoint module="luxe: render" class="RenderPathContext" signature="layer_compute(name : Any, compute_layer_desc : Any)"></endpoint>
<signature id="RenderPathContext.layer_compute+2">RenderPathContext.layer_compute(**name**: `Any`, **compute_layer_desc**: `Any`)
<a class="headerlink" href="#RenderPathContext.layer_compute+2" title="Permanent link">¶</a></signature>
<span class='api_ret'>returns</span> `:::js unknown`
> :todo: desc   
```js
//:todo: example
