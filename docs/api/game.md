...
- [schedule](#Frame.schedule+2)(**time**: `Any`, **fn**: `Any`)
- [schedule](#Frame.schedule+3)(**time**: `Any`, **count**: `Any`, **fn**: `Any`)
- [unschedule](#Frame.unschedule)(**handle**: `Any`)
- [off](#Frame.off)(**handle**: `Any`)
- [on](#Frame.on+3)(**section**: `Any`, **priority**: `Any`, **fn**: `Any`)
- [before](#Frame.before+3)(**section**: `Any`, **priority**: `Any`, **fn**: `Any`)
- [after](#Frame.after+3)(**section**: `Any`, **priority**: `Any`, **fn**: `Any`)
- [on](#Frame.on+2)(**section**: `Any`, **fn**: `Any`)
- [before](#Frame.before+2)(**section**: `Any`, **fn**: `Any`)
...
<endpoint module="luxe: game" class="Frame" signature="schedule(time : Any, fn : Any)"></endpoint>
<signature id="Frame.schedule+2">Frame.schedule(**time**: `Any`, **fn**: `Any`)
...
<endpoint module="luxe: game" class="Frame" signature="schedule(time : Any, count : Any, fn : Any)"></endpoint>
<signature id="Frame.schedule+3">Frame.schedule(**time**: `Any`, **count**: `Any`, **fn**: `Any`)
...
<endpoint module="luxe: game" class="Frame" signature="unschedule(handle : Any)"></endpoint>
<signature id="Frame.unschedule">Frame.unschedule(**handle**: `Any`)
...
<endpoint module="luxe: game" class="Frame" signature="off(handle : Any)"></endpoint>
<signature id="Frame.off">Frame.off(**handle**: `Any`)
...
<endpoint module="luxe: game" class="Frame" signature="on(section : Any, priority : Any, fn : Any)"></endpoint>
<signature id="Frame.on+3">Frame.on(**section**: `Any`, **priority**: `Any`, **fn**: `Any`)
...
<endpoint module="luxe: game" class="Frame" signature="before(section : Any, priority : Any, fn : Any)"></endpoint>
<signature id="Frame.before+3">Frame.before(**section**: `Any`, **priority**: `Any`, **fn**: `Any`)
...
<endpoint module="luxe: game" class="Frame" signature="after(section : Any, priority : Any, fn : Any)"></endpoint>
<signature id="Frame.after+3">Frame.after(**section**: `Any`, **priority**: `Any`, **fn**: `Any`)
...
<endpoint module="luxe: game" class="Frame" signature="on(section : Any, fn : Any)"></endpoint>
<signature id="Frame.on+2">Frame.on(**section**: `Any`, **fn**: `Any`)
...
<endpoint module="luxe: game" class="Frame" signature="before(section : Any, fn : Any)"></endpoint>
<signature id="Frame.before+2">Frame.before(**section**: `Any`, **fn**: `Any`)
...
<span class='api_ret'>returns</span> `:::js unknown`
> Called via `super()` inside your ready function.   
...
<a class="headerlink" href="#Ready.ready" title="Permanent link">¶</a></signature>
<span class='api_ret'>returns</span> `:::js None`
> Called via `super("hello")` inside your ready function.   
