...
> ```js
>   var control = Control.create(_ui)
>   System.print(Control.valid(control)) //true
>   Control.destroy(control)
>   System.print(Control.valid(control)) //false
> ```   
...
>   System.print(control == control_by_id) //true
> ```   
...
>   System.print(bounds) // [150, 150, 20, 20]
> ```   
...
>   System.print(bounds) // [100, 100, 20, 20]
> ```   
...
>   var bounds = [0,0,0,0]
>   Control.get_bounds_abs(child, bounds)
>   System.print(bounds) //[225, 225, 50, 50]
> 
>   Control.clear(parent, UIClear.destroy)
>   System.print(Control.child_count(parent)) //0
>   System.print(Control.valid(child)) //false
> 
>   UI.commit(_ui)
> ```   
