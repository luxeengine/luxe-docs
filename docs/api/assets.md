...
- [font_page](#Assets.font_page+2)(**id**: `String`, **page**: `Num`)
...
- [has_font](#Assets.has_font)(**id**: `String`)
...
<endpoint module="luxe: assets" class="Assets" signature="font_page(id : String, page : Num)"></endpoint>
<signature id="Assets.font_page+2">Assets.font_page(**id**: `String`, **page**: `Num`)
...
<endpoint module="luxe: assets" class="Assets" signature="has_font(id : String)"></endpoint>
<signature id="Assets.has_font">Assets.has_font(**id**: `String`)
